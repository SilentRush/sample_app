...
(function() {
  $(function() {
    ...
    $(".clickable-set").click(function() {
      ...
      return $("[id=" + $(this).data("id") + "]").toggleClass("show");
    });
    ...
    $(".set-match-container").on("click", ".currentMap", function() {
      return $(this).parent().find(".map-list").show();
    });
    $(".set-match-container").on("click", ".selectedMap", function() {
      var image, map, parent;
    ...
    $(".set-match-container").on("click", ".currentChar", function() {
      return $(this).parent().find(".char-list").show();
    });
    $(".set-match-container").on("click", ".selectedChar", function() {
      var char, image, parent;
      parent = $(this).parent().parent();
    ...
    return $(".set-match-container").on("click", ".match-player", function() {
      var lose, parent, win;
      parent = $(this).parent();
      win = parent.find(".Win");
      ...
      return lose.find("input").attr("value", "Win");
    });
  });
