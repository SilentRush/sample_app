...
(function() {
  ...
  $(function() {
    var checkForUpdate, getcharlist, getmaplist, loadSetInformation, sortrow, updateSet, updateWatcher;
    $(".clickable-row").click(function() {
      return $("[id=" + $(this).data("id") + "]").toggle();
    });
    ...
    sortrow = function() {
      return $(".player-row").each(function(index, row) {
        console.log($(row).find(".seed"));
        return $(row).find(".seed").html(index + 1 + ". ");
      });
    };
    $("#sortable").on("sortstop", function(e, ui) {
      return sortrow();
    });
    getcharlist = function(char) {
      char = ["bowser", "captainfalcon", "dk", "drmario", "falco", "fox", "ganondorf", "iceclimbers", "jigglypuff", "kirby", "link", "luigi", "mario", "marth", "mewtwo", "mrgamewatch", "ness", "peach", "pichu", "pikachu", "roy", "samus", "sheik", "yoshi", "younglink", "zelda", "unknown"];
      return char;
    };
    getmaplist = function(map) {
    ...
    $('.createPlayer').click(function() {
      return $('.create-player').toggle();
    });
    loadSetInformation = function(ele) {
      return $.ajax({
        ...
        success: function(data, status, response) {
          ...
          if (data.topPlayer_id !== null && data.bottomPlayer_id !== null) {
            ...
            $(data.matches).each(function(index, match) {
              var chars, currcharacter, currcharimg, currcharinput, currmap, currmapimg, currmapinput, maps, matchcharacter, matchmap, matchplayer, matchplayerinput, matchplayerspan, matchrow;
              ...
              return $('.set-match-container').append(matchrow);
            });
            box.toggleClass("show");
            return box.css("margin-top", -(box.height() / 2));
          }
        },
        error: function() {
          return $('#results').html("ERROR");
        }
      });
    };
    updateSet = function(ele) {
      var bot, botChar, botPlayer, botScore, div, top, topChar, topPlayer, topScore;
      ...
      if (ele.topPlayer === ele.winner && ele.winner !== "") {
        ...
        $(ele.wchar).each(function(index, char) {
          var img;
          ...
          return $(topChar).append(img);
        });
        $(ele.lchar).each(function(index, char) {
          var img;
          img = document.createElement("img");
          if (char === "") {
            char = "unknown";
    ...
    checkForUpdate = function() {
      ...
      return $.ajax({
        ...
        success: function(data, status, response) {
          return $(data).each(function(index, set) {
            return updateSet(set);
          });
        },
        error: function() {
          return $('#player-errors').html("ERROR");
        }
      });
    };
    updateWatcher();
    $('#setform').submit(function(e) {
      var data, date, newdate;
      e.preventDefault();
      ...
      return $.ajax({
        ...
        data: data,
        success: function(data, status, response) {
          $(data).each(function(index, set) {
            return updateSet(set);
          });
          return $(".set-information").fadeOut(function() {
    ...
    $(".clickable-set").click(function() {
      if ($(".set-information").hasClass("show")) {
        return $('.set-information').fadeOut(function() {
          return $(".set-information").removeClass("show");
        });
      } else {
        return loadSetInformation(this);
      }
    });
    $(".set-information-close").click(function() {
      $('.set-information').fadeOut(function() {
        return $('.set-information').removeClass("show");
      });
      $('.map-list').fadeOut(function() {
        return $('.map-list').hide();
      });
      return $('.char-list').fadeOut(function() {
        return $('.char-list').hide();
      });
    });
    ...
    $(".plus").click(function() {
      var div, html, id, newRow, parent;
      parent = $(this).parent().parent().parent();
      id = parent.find(".match-row").length + 1;
      div = parent.find(".set-match-container");
      html = "<div class=\"match-row\">" + div.find(".match-row").html() + "</div>";
      if (id < 8) {
        div.append(html);
        newRow = div.find(".match-row").last();
        return parent.find("[name=matchCount]").attr("value", id);
      }
    });
    $(".minus").click(function() {
      var div, id, parent, row;
      parent = $(this).parent().parent().parent();
      div = parent.find(".set-match-container");
    ...
    $(".set-match-container").on("click", ".currentMap", function() {
      $(".map-list").show();
      $(".map-list").css("margin-top", -($(".map-list").height() / 2));
      return tournamentVars.ele = this;
    });
    $(".set-information").on("click", ".selectedMap", function() {
      var image, map;
    ...
    $(".set-match-container").on("click", ".currentChar", function() {
      $(".char-list").show();
      $(".char-list").css("margin-top", -($(".char-list").height() / 2));
      return tournamentVars.ele = this;
    });
    $(".set-information").on("click", ".selectedChar", function() {
      var char, image;
    ...
    $(".set-match-container").on("click", ".match-player", function() {
      var lose, parent, win;
      parent = $(this).parent();
      win = $(this);
      ...
      return win.find("input").attr("value", "Win");
    });
    $("#search").on('keypress', (function(e) {
      if (e.keyCode === 13) {
        return $(".addPlayer").click();
      }
    }).bind(this));
    $(".addPlayer").click(function() {
      var delBtn, gamertag, id, idInput, row, seed, span;
      gamertag = $('#search');
      id = $('[name=id]');
      console.log(id.val());
      ...
      if (id.val() !== "") {
        ...
        return $('.player-errors').css({
          "color": "red"
        });
      }
    });
    return $(".player-container-list").on("click", ".delBtn", function() {
      return $(this).parent(".player-row").fadeOut(function() {
        $(this).remove();
        return sortrow();
      });
    });
