...
(function() {
  ...
  $(function() {
    var getcharlist, getmaplist, loadSetInformation, sortrow;
        ...
        success: function(data, status, response) {
          ...
          if (data.topPlayer_id !== null && data.bottomPlayer_id !== null) {
            ...
            $(data.matches).each(function(index, match) {
              var charlist, chars, currcharacter, currcharimg, currcharinput, currmap, currmapimg, currmapinput, maps, matchcharacter, matchmap, matchplayer, matchplayerinput, matchplayerspan, matchrow;
